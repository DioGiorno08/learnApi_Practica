...
import IntegracionBackFront.backfront.Services.Cloudinary.CloudinarySevice;
...
public class CloudinaryController {
    ...
    @Autowired
    private final CloudinarySevice service;

    public CloudinaryController(CloudinarySevice service){
    ...
    {
        return ResponseEntity.internalServerError().body("Error al Insertar la imagen ");
     }
   }
}
